...
const TEXTS: Record<string, string> = {
  ...
  GAMBLE: "Die 1-6 - 1/2: 8 dmg to you / 3/4: 5 dmg to opponent / 5: summon Mana Golem (2/5) / 6: summon 3 Glass Cannons (5/1)",
  DICE8: "Die 1-6 - 1/2: your max mana -4 / 3/4: opponent MAX mana -1 & 14 dmg / 5: Storm Warrior (11/9, double attack) / 6: wipe enemy spells & traps + 2 Storm Warriors + max mana +2 + your HP +10",
