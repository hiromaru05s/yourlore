...
const TEXTS: Record<string, string> = {
  ...
  GHOST: "Infiltrate · Whenever the opponent raises their max mana or max HP, YOU take 2 damage",
...
Object.assign(TEXTS, {
  ...
  DRAGON_EGG: "【Passive】Cannot attack · Hatches in 8 turns (both turns) · Durability 6, enemy attacks take 1 · Hatch with durability left → a Black, Red or Blue Dragon",
  BEAST_EGG: "【Passive】Cannot attack · Hatches in 10 turns (both turns) · Durability 7, enemy attacks take 1 · Hatch with durability left → the Divine Beast",
  GUILD_HALL: "【Passive】+1 count when your 'Assassin' monsters or this monster damage the enemy · 3 counts: 14 damage, reset · Destroyed: counts lost",
  ANCIENT_CIV: "【Lasts 13 Turns】After 13 turns: max mana -1 and add a 'Dragon Egg' or 'Divine Beast Egg' to hand · Then exiled",
  VAMP_BUTLER: "【Passive】+1 blood count when this monster attacks an enemy monster · Every 3: summon an 'Apprentice Vampire' · Counts as a 'Vampire'",
  ELDER_ELF_KING: "【Requires】a 'High Elf' in your graveyard, your max HP 99+ · 【On Summon】summon 2 High Elves, then your 'High Elf' +15 ATK (lasting)",
  ...
  FATE_WHEEL: "【Permanent】on cast: max mana -1, take 5 damage · You may reroll a dice card's result (once per turn)",
  CHOSEN_KNIGHT: "【Passive】+1/+1 per 2 exiled 'Culls' of yours · When it damages the enemy, add a Cull to your graveyard",
  SHATTER: "Take 5 damage · Every monster on both fields drops to 1 MAX HP (lasting; damage taken cleared; Eggs excluded)",
  AMBUSH: "【Requires】enemy max mana exactly 4 · Deal 7 damage, take 3 · Exiled after use",
  COUNTERCALC: "【Requires】enemy max mana 6- · Destroy 1 enemy enchantment · Exiled after use",
