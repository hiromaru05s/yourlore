...
const TEXTS: Record<string, string> = {
  ...
  S13: "Deal 9 damage to the opponent", S14: "Restore 10 HP + draw 1 card", S15: "Destroy 1 enemy monster of cost 8 or less",
  ...
  MEDITATE: "Castable only if you played no other card this turn. Restore HP up to 80% of max",
  ...
  WORLD_CARE: "Enchantment: at the start of each of your turns, max HP +15",
