...
const NAMES: Record<string, string> = {
  ...
  BLOOD1: "Blood Magic - Basic", BLOOD2: "Blood Magic - Advanced",
...
const TEXTS: Record<string, string> = {
  ...
  NHEAL: "Enchantment: restore 1 HP whenever you summon a monster (Cast 2)",
  ...
  BLOOD1: "Take 4 damage, draw 3 cards (Cast 1)", BLOOD2: "Take 8 damage, draw 6 cards (Cast 2)",
  ...
  EGG_HUNTER: "When this card attacks an 'Egg', it consumes 3 durability counters",
  INCUBATOR: "Reduce the hatch counter of one of your 'Eggs' by 5 turns",
  EGG_MASTER: "On summon: all 'Eggs' on your field gain +1 durability",
  ...
  VAMP1: "When you cast a 'Blood Magic': summon a Novice Vampire (once) · Exiled from the game when it dies",
  VAMP2: "When you cast a 'Blood Magic': summon an Adept Vampire (once) · Exiled from the game when it dies",
  VAMP3: "When you cast a 'Blood Magic': summon an Elite Vampire (once) · Exiled from the game when it dies",
  VAMP4: "When you cast a 'Blood Magic': summon a Supreme Vampire (once) · Gains max HP equal to 50% of the damage it deals to the opponent · Exiled from the game when it dies",
  VAMP5: "On summon: deal 15 damage to the opponent and gain +30 max HP · Gains max HP equal to the damage it deals to the opponent · Cannot be destroyed by trap cards · Exiled from the game when it dies",
  ...
  LIFE_SANCTUM: "Enchantment: max HP +2 each of your turns (Cast 2)",
  WORLD_HEART: "Enchantment: max HP +7 each of your turns. Your max mana -2 while this is on the field (Cast 4)",
  ...
  PRAYER: "Castable only if your max mana is 12 or less and you played no other card this turn. Restore HP up to 80% of max (Cast 5)",
  ...
  GOLIATH_HUNT: "Destroy 1 enemy monster with DEF 20 or more",
  ...
  DRAGON_EGG: "Cannot attack · Hatches in 8 turns (both players' turns) / Durability 4 · Enemy monster attacks only consume 1 durability · If hatching completes with durability left, one of Black/Red/Blue Dragon is summoned",
  BEAST_EGG: "Cannot attack · Hatches in 10 turns (both players' turns) / Durability 4 · Enemy monster attacks only consume 1 durability · If hatching completes with durability left, the Divine Beast is summoned",
  D_BLACK: "On summon: choose up to 8 of the opponent's exiled cards and send them to their graveyard · All enemy monsters -3 DEF (lasting) · Exiled from the game when it dies",
  D_RED: "On summon: deal 15 damage to the opponent · Aura: your spells deal +3 extra damage to the opponent · Exiled from the game when it dies",
  D_BLUE: "On summon: your max HP +20 · At the start of your turn: max HP + the number of enemy monsters · Exiled from the game when it dies",
  DIVINE: "On summon: max mana +15 · +1 draw each turn (permanent) · Choose and destroy 3 of the opponent's cards (monsters, set traps, enchantments) · Aura: cannot be targeted by the opponent's spell/monster effects · Exiled from the game when it dies",
