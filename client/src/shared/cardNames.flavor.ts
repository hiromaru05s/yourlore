...
export const FLAVOR_CARD_NAMES: Record<string, LocalizedCardName> = {
  // Core spells
...
export function applyFlavorCardNames(pools: Array<Record<string, CardDef>>): void {
