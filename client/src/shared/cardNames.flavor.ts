...
export const FLAVOR_CARD_NAMES: Record<string, LocalizedCardName> = {
  ...
  GT5_4: { ko: "아귀의 식탐", ja: "餓鬼の食い意地", en: "Gluttonous Maw" },
  ...
  GT8_5: { ko: "낙인", ja: "烙印", en: "The Brand" },
  ...
  GT9_3: { ko: "영혼 교환", ja: "魂の交換", en: "Soul Exchange" },
  ...
  GT12_1: { ko: "심판의 카운트다운", ja: "審判のカウントダウン", en: "Judgment Countdown" },
};
