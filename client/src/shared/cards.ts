...
const PATCH29: Record<string, Partial<CardDef>> = {
  ...
  TRICKROOM: { text: "2턴 동안 양 필드 전 몬스터의 공격과 최대 체력을 맞바꾼다(누적 데미지 유지 · 최대 체력이 그 이하면 파괴) · 반전 중엔 체력 상승 효과가 공격을, 공격 상승 효과가 체력을 올린다 · 종료 시 오른 스탯은 계승",
    textJa: "2ターンの間、両場の全モンスターの攻撃と最大体力を入れ替える(蓄積ダメージ維持 · 最大体力がそれ以下なら破壊) · 反転中は体力上昇効果が攻撃を、攻撃上昇効果が体力を上げる · 終了時、上がった値は継承" },
