...
const PATCH2: Record<string, Partial<CardDef>> = {
  ...
  GS9_2: { val: 16, text: "자신 체력 16 회복 · 패의 '생명의 빛' 1장 묘지로 보내면 자신 최대 체력 +15", textJa: "自分の体力16回復 · 手札の「生命の光」1枚を墓地へ送ると自分の最大体力+15" },
...
// ============================================================
export const BALANCE_VERSION = "v26"; // v26: 붕괴 진동 재정의(전원 체력 1로·즉사 제거), 세계수의 보살핌 +12→+9\n// v25: 벽 상향 — 수문장 3코 0/13, 바위거북 1/8, 마나거인 1/10, 수정정령 0/9
