...
export const DB: Record<string, CardDef> = {
  ...
  M8: { id: "M8", t: "mon", cost: 3, name: "그로브 워든", atk: 4, def: 5, text: "소환시: 체력 6 회복", onSummon: "heal6" },
  ...
  S9: { id: "S9", t: "spell", cost: 3, name: "사이펀", text: "상대에게 4 데미지 + 자신 체력 4 회복", act: "siphon" },
  ...
  S14: { id: "S14", t: "spell", cost: 4, name: "대지의 축복", text: "체력 12 회복 + 카드 1장 드로우", act: "blessing" },
  ...
  T10: { id: "T10", t: "trap", cost: 3, name: "영혼 포식", text: "공격 몬스터를 파괴하고 자신 체력 6 회복", react: "devour" },
