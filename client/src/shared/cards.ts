...
const NEW_CARDS4: CardDef[] = [
  { id: "LUCKY_CHEST", t: "spell", cost: 3, ench: "chestLock", val: 99, name: "행운의 보물상자", nameJa: "幸運の宝箱",
    text: "발동시 — 10%: 최대 마나+3·2장 드로우 / 40%: 최대 마나+1 / 30%: 최대 체력+8 / 5%: 최대 체력+12 / 15%: 꽝(상대 필드에 마스터 미믹 10/3). 영구: 이 카드가 있는 한 양측은 보물상자를 열 수 없다 (어튠 - 마는 사용 가능)",
    textJa: "発動時 — 10%: 最大マナ+3・2枚ドロー / 40%: 最大マナ+1 / 30%: 最大体力+8 / 5%: 最大体力+12 / 15%: ハズレ(相手の場にマスターミミック10/3)。永続: このカードがある限り両者は宝箱を開けられない (アチューン・魔は使用可能)" },
