...
const NEW_CARDS15: CardDef[] = [
  ...
  { id: "ELDER_ELF_KING", t: "mon", cost: 7, atk: 2, def: 8, onSummon: "elderKing", summonReq: "elderKing", name: "엘더 하이엘프 킹", nameJa: "エルダーハイエルフキング",
    text: "【조건】묘지에 '하이엘프', 자신 최대 체력 99 이상 · 【소환시】하이엘프 2체 소환 후 '하이엘프' 전체 공격 +15(지속)",
    textJa: "【条件】墓地に「ハイエルフ」、自分の最大体力99以上 · 【召喚時】ハイエルフ2体を召喚後、「ハイエルフ」全体の攻撃+15(持続)" },
];
...
const PATCH19: Record<string, Partial<CardDef>> = {
  // ---- 버프 (스타터 최하위) ----
  FATE_WHEEL: { text: "영구: 시전 시 자신 최대 마나 -1, 자신에게 5 데미지 · 주사위 결과를 본 뒤 다시 굴릴 수 있다 (매턴 1회) · 공허",
