...
export function paintDuelClock(el: HTMLElement, seconds: number, total: number, mine: boolean): void {
  ...
  if (!el.querySelector('.tc-num')) el.innerHTML = '<span class="tc-dial"><svg viewBox="0 0 60 60" aria-hidden="true"><circle class="tc-track" cx="30" cy="30" r="26"/><circle class="tc-progress" cx="30" cy="30" r="26" pathLength="1"/></svg><span class="tc-num"></span></span>';
