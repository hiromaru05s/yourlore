...
const D: Record<string, Entry> = {
  ...
  "bot.diff.title": { ko: "난이도 선택", ja: "難易度を選択", en: "Choose Difficulty" },
  "bot.diff.sub": { ko: "상대할 AI의 강함을 고르세요.", ja: "対戦するAIの強さを選んでください。", en: "Pick how tough the AI should be." },
  "bot.diff.easy": { ko: "쉬움", ja: "やさしい", en: "Easy" },
  "bot.diff.easy.desc": { ko: "실수가 잦은 입문용 AI.", ja: "ミスが多い入門用AI。", en: "A forgiving AI that blunders often." },
  "bot.diff.normal": { ko: "보통", ja: "ふつう", en: "Normal" },
  "bot.diff.normal.desc": { ko: "정석대로 두는 기본 AI.", ja: "定石通りに指す標準AI。", en: "A solid AI that plays by the book." },
  "bot.diff.hard": { ko: "어려움", ja: "むずかしい", en: "Hard" },
  "bot.diff.hard.desc": { ko: "수읽기로 최선수를 노린다.", ja: "先読みで最善手を狙う。", en: "Reads ahead to find the best line." },
  "bot.diff.hell": { ko: "헬", ja: "ヘル", en: "Hell" },
  "bot.diff.hell.desc": { ko: "타협 없는 최강의 AI.", ja: "妥協なしの最強AI。", en: "Relentless — the strongest AI." },
