...
const D: Record<string, Entry> = {
  ...
  "tut.s2.body": { ko: "가운데 <b>마켓</b>에서 마나로 카드를 삽니다. <b>고정 마켓</b>은 매판 같은 8장, <b>제시 마켓</b>은 매 턴 바뀌는 4장이에요. 산 카드는 <b>묘지</b>로 갔다가 덱이 떨어지면 섞여 들어옵니다. 아무 카드나 <b>1장 구매</b>해보세요!", ja: "中央の<b>マーケット</b>でマナを使いカードを買います。<b>固定マーケット</b>は毎ゲーム同じ8枚、<b>提示マーケット</b>は毎ターン変わる4枚です。買ったカードは<b>墓地</b>へ行き、デッキが尽きると混ざって戻ります。どれでも<b>1枚購入</b>！", en: "Buy cards with mana in the central <b>market</b>. The <b>fixed market</b> is the same 8 all game; the <b>offer</b> refreshes each turn. Purchases go to your <b>graveyard</b> and shuffle back in. <b>Buy any one card</b>!" },
  ...
  "game.brandTip": { ko: "낙인 카운터 {n}개 — 매 턴 시작시 카운터당 주사위 1개만큼 자해", ja: "烙印カウンター{n}個 — 毎ターン開始時にカウンターごとにダイス1個分の自傷", en: "{n} Brand counter(s) — at each turn start, take 1 die of damage per counter" },
