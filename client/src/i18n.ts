...
const D: Record<string, Entry> = {
  ...
  "home.online.title": { ko: "노말 대전", ja: "ノーマル対戦", en: "Normal Match" },
  ...
  "home.inquiry.title": { ko: "문의", ja: "お問い合わせ", en: "Contact" },
  "home.inquiry.desc": { ko: "요청사항·버그를 보내주세요.", ja: "ご要望・バグ報告を送ってください。", en: "Send us requests or bug reports." },
  "inquiry.bubble": { ko: "요청사항 / 버그보고해주세요!", ja: "ご要望 / バグ報告おねがいします！", en: "Requests / bug reports welcome!" },
  "inquiry.modal.title": { ko: "문의 보내기", ja: "お問い合わせ", en: "Contact Us" },
  "inquiry.field.title": { ko: "제목", ja: "件名", en: "Title" },
  "inquiry.field.body": { ko: "내용", ja: "内容", en: "Message" },
  "inquiry.ph.title": { ko: "제목을 입력하세요", ja: "件名を入力してください", en: "Enter a title" },
  "inquiry.ph.body": { ko: "요청사항이나 버그 내용을 자세히 적어주세요", ja: "ご要望やバグの内容を詳しくお書きください", en: "Describe your request or the bug in detail" },
  "inquiry.send": { ko: "보내기", ja: "送信", en: "Send" },
  "inquiry.sending": { ko: "보내는 중…", ja: "送信中…", en: "Sending…" },
  "inquiry.sent": { ko: "접수되었습니다. 소중한 의견 감사합니다!", ja: "受け付けました。貴重なご意見ありがとうございます！", en: "Received — thank you for your feedback!" },
  "inquiry.fail": { ko: "전송에 실패했습니다. 잠시 후 다시 시도해주세요.", ja: "送信に失敗しました。しばらくしてからもう一度お試しください。", en: "Failed to send. Please try again later." },
  "inquiry.need": { ko: "제목과 내용을 모두 입력해주세요", ja: "件名と内容を両方入力してください", en: "Please fill in both the title and the message" },
  // card list / gallery
  ...
  "tutorial.inter.desc": { ko: "실제 게임 화면에서 10단계로 배워요. 단계마다 크레딧을 드리고, <b>전부 수료하면 총 1000💎</b>!", ja: "実際のゲーム画面で10ステップで学べます。ステップごとにクレジット、<b>全部クリアで合計1000💎</b>！", en: "Learn in 10 hands-on steps on the real board. Earn credits each step — <b>1000💎 total</b> for finishing!" },
  ...
  "tut.s1.title": { ko: "화면 이해", ja: "画面を知る", en: "Meet the Board" },
  "tut.s1.body": { ko: "위쪽이 <b>상대</b>, 아래쪽이 <b>나</b>입니다. 내 턴이 오면 <b>마나가 최대치까지</b> 차고 카드를 <b>3장 드로우</b>해요. 목표는 상대 <b>체력을 0</b>으로! <b>팁</b>: 첫 4턴은 무리하지 말고 <b>저코스트 카드를 사서 덱을 다지는</b> 게 정석이에요.", ja: "上が<b>相手</b>、下が<b>自分</b>です。自分のターンが来ると<b>マナが最大まで</b>回復し、カードを<b>3枚ドロー</b>。目標は相手の<b>体力を0</b>に！<b>ヒント</b>: 最初の4ターンは無理せず<b>低コストのカードを買ってデッキを固める</b>のが定石です。", en: "Top is the <b>opponent</b>, bottom is <b>you</b>. Each turn your <b>mana refills</b> and you <b>draw 3</b>. Goal: drop their <b>HP to 0</b>! <b>Tip</b>: for the first ~4 turns, don't overextend — <b>buy cheap cards to build your deck</b>." },
  "tut.s2.title": { ko: "카드 구매", ja: "カード購入", en: "Buy a Card" },
  "tut.s2.body": { ko: "중앙의 <b>마켓</b>에서 마나로 카드를 빌립니다. 기본 재고 3장인 8칸과 1장인 4칸이 있어요. <b>파란 선의 4칸</b>만 리롤됩니다. 빌린 카드는 <b>셸프</b>에 놓이고, 덱이 떨어지면 섞여 돌아옵니다. <b>카드 1장을 구매</b>해보세요!", ja: "中央の<b>マーケット</b>でマナを使ってカードを借ります。基本在庫3枚の8枠と、在庫1枚の4枠があります。リロールは<b>青いラインの4枠だけ</b>が対象です。借りたカードは<b>シェルフ</b>へ行き、デッキが尽きると混ざって戻ります。どれでも<b>1枚購入</b>してみましょう！", en: "Borrow cards with mana from the central <b>market</b>: eight slots start with 3 in stock, and four have 1. Reroll changes only <b>the four blue-lined slots</b>. Purchases go to your <b>Shelf</b> and shuffle back when your deck runs out. <b>Buy any one card</b>!" },
  "tut.s3.title": { ko: "제시 리롤", ja: "提示リロール", en: "Reroll the Offer" },
  "tut.s3.body": { ko: "<b>제시 마켓</b>이 마음에 안 들면 <b>갱신(리롤)</b> 버튼으로 <b>1마나</b>를 내고 4장을 새로 뽑을 수 있어요. 원하는 카드가 없을 때 유용합니다. <b>갱신</b> 버튼을 눌러보세요!", ja: "<b>提示マーケット</b>が気に入らなければ<b>更新(リロール)</b>ボタンで<b>1マナ</b>を払い4枚を引き直せます。欲しいカードが無い時に便利。<b>更新</b>ボタンを押してみましょう！", en: "Don't like the <b>offer</b>? The <b>reroll</b> button spends <b>1 mana</b> to draw 4 fresh cards — great when nothing fits. Tap the <b>reroll</b> button!" },
  "tut.s4.title": { ko: "몬스터 소환", ja: "モンスター召喚", en: "Summon a Monster" },
  "tut.s4.body": { ko: "손패에 <b>몬스터 카드</b>를 넣어드렸어요. 패를 눌러 펼친 뒤, 카드를 <b>위로 드래그해 소환</b>하세요. 몬스터는 <b>공격력/체력</b>을 가지고 필드에서 싸웁니다. 소환한 턴에도 바로 공격할 수 있어요!", ja: "手札に<b>モンスターカード</b>を入れました。手札を開いて、カードを<b>上へドラッグして召喚</b>しましょう。モンスターは<b>攻撃力/体力</b>を持ち場で戦います。召喚したターンにすぐ攻撃できます！", en: "A <b>monster card</b> is in your hand — open your hand and <b>drag it up to summon</b> it. Monsters have <b>ATK/HP</b> and fight on the field, and can attack the turn they're summoned!" },
  "tut.s5.title": { ko: "마법 시전", ja: "魔法発動", en: "Cast a Spell" },
  "tut.s5.body": { ko: "<b>마법 카드</b>를 드렸어요(파이어볼 — 상대에게 4 데미지). 마법은 <b>즉시 1회</b> 효과를 내고 묘지로 갑니다(데미지·회복·드로우·파괴 등). 카드를 <b>위로 드래그해 시전</b>하세요!", ja: "<b>魔法カード</b>を渡しました(ファイアボール — 相手に4ダメージ)。魔法は<b>即時1回</b>の効果を出し墓地へ(ダメージ・回復・ドロー・破壊など)。カードを<b>上へドラッグして発動</b>！", en: "Here's a <b>spell</b> (Fireball — 4 damage). Spells are <b>one-shot</b> effects that then go to the graveyard (damage, heal, draw, destroy…). <b>Drag it up to cast</b>!" },
  "tut.s6.title": { ko: "공격", ja: "攻撃", en: "Attack" },
  "tut.s6.body": { ko: "필드의 <b>몬스터를 눌러</b> 공격하세요. 상대 몬스터를 치면 <b>데미지가 체력에 누적</b>돼요. 체력 0이면 파괴, 막타 초과분은 <b>관통</b> 데미지! 상대 필드가 비면 <b>상대 체력을 직접</b> 때립니다!", ja: "場の<b>モンスターを押して</b>攻撃。相手モンスターを攻撃すると<b>ダメージが体力に蓄積</b>。体力0で破壊、とどめの超過分は<b>貫通</b>ダメージ！相手の場が空なら<b>相手の体力を直接</b>攻撃！", en: "Tap your <b>field monster</b> to attack. Attacks <b>accumulate damage on a monster's HP</b>; at 0 it dies and the killing blow's excess <b>pierces</b>. With no enemy monsters, you hit <b>their HP directly</b>!" },
  "tut.s7.title": { ko: "함정", ja: "罠", en: "Traps" },
  "tut.s7.p0": { ko: "<b>함정 카드</b>를 드렸어요. 함정은 <b>비공개로 세트</b>해두고 상대의 <b>공격·소환·마법</b>에 반응해 자동 발동합니다(발동 시 공개). 카드를 <b>위로 드래그해 세트</b>하세요.", ja: "<b>罠カード</b>を渡しました。罠は<b>非公開でセット</b>し、相手の<b>攻撃・召喚・魔法</b>に反応して自動発動します(発動時に公開)。カードを<b>上へドラッグしてセット</b>。", en: "Here's a <b>trap</b>. Traps are <b>set face-down</b> and fire automatically on enemy <b>attacks, summons or spells</b> (revealed when triggered). <b>Drag it up to set</b> it." },
  "tut.s7.p1": { ko: "좋아요! 이제 <b>턴을 종료</b>하고 상대의 공격을 지켜보세요. 세트한 함정이 자동으로 발동해 당신을 지켜줄 거예요…", ja: "いいですね！では<b>ターンを終了</b>して相手の攻撃を見てみましょう。セットした罠が自動で発動して守ってくれます…", en: "Nice! Now <b>end your turn</b> and watch the opponent attack — your set trap will fire automatically to protect you…" },
  "tut.s8.title": { ko: "종족 시너지", ja: "種族シナジー", en: "Tribe Synergy" },
  "tut.s8.body": { ko: "<b>같은 종족</b>(고독)의 서로 <b>다른</b> 몬스터 2장을 드렸어요. 둘 다 <b>소환</b>하면 <b>동족 2종 시너지</b>가 터집니다! 종족은 고독·포식·귀족·마족·시초 5종이 있어요. 두 마리를 <b>모두 소환</b>하세요!", ja: "<b>同じ種族</b>(孤独)の<b>異なる</b>モンスター2枚を渡しました。両方<b>召喚</b>すると<b>同族2種シナジー</b>が発動！種族は孤独・捕食・貴族・魔族・始原の5種。2体とも<b>召喚</b>しましょう！", en: "You have two <b>different</b> monsters of the <b>same tribe</b> (Solitary). <b>Summon both</b> to trigger a <b>2-of-a-tribe synergy</b>! There are 5 tribes. <b>Summon both</b> monsters!" },
  "tut.s9.title": { ko: "어튠 (마나 성장)", ja: "アチューン(マナ成長)", en: "Attune (Mana Growth)" },
  "tut.s9.body": { ko: "<b>어튠</b> 카드를 드렸어요. 마나는 저절로 늘지 않고 <b>어튠</b> 같은 카드로 <b>최대 마나를 영구히 +1</b> 해야 커집니다. 마나가 커질수록 강한 카드를 쓸 수 있어요. 어튠을 <b>사용</b>하세요!", ja: "<b>アチューン</b>カードを渡しました。マナは自然には増えず、<b>アチューン</b>のようなカードで<b>最大マナを永続+1</b>して伸ばします。マナが増えるほど強いカードを使えます。アチューンを<b>使用</b>！", en: "Here's an <b>Attune</b>. Mana doesn't grow on its own — cards like <b>Attune</b> raise your <b>max mana permanently (+1)</b>. More mana = stronger plays. <b>Use</b> the Attune!" },
  "tut.s10.title": { ko: "승리", ja: "勝利", en: "Victory" },
  "tut.s10.body": { ko: "훌륭해요! 상대 체력이 <b>거의 없습니다</b>. 필드의 몬스터로 <b>직접 공격</b>해 마무리하고 튜토리얼을 <b>완주</b>하세요! (총 <b>1000💎</b> 획득)", ja: "お見事！相手の体力は<b>ほぼ残っていません</b>。場のモンスターで<b>直接攻撃</b>してとどめを刺し、チュートリアルを<b>完走</b>しましょう！(合計<b>1000💎</b>獲得)", en: "Great work! The opponent is <b>nearly finished</b>. <b>Attack directly</b> with your monster to end it and <b>complete</b> the tutorial! (Total <b>1000💎</b>)" },
  ...
  "duel.market": { ko: "마켓", ja: "マーケット", en: "Market" },
  ...
  "game.discard": { ko: "셸프", ja: "シェルフ", en: "Shelf" },
  ...
  "notice.voided.title": { ko: "매칭 취소", ja: "マッチング中止", en: "Match Canceled" },
  "notice.voided.body": { ko: "상대가 참가하지 않아 매칭이 취소되었습니다 (점수 변동 없음).", ja: "相手が参加しなかったため、マッチングは中止されました（レート変動なし）。", en: "Your opponent never joined, so the match was canceled (no rating change)." },
  "game.timer.sec": { ko: "{n}초", ja: "{n}秒", en: "{n}s" },
  "api.fail": { ko: "요청 실패 ({n})", ja: "リクエストに失敗しました ({n})", en: "Request failed ({n})" },
  ...
  "deck.removed": { ko: "리프트", ja: "リフト", en: "Rift" },
  ...
  // profile tabs
  "profile.tab.overview": { ko: "프로필", ja: "プロフィール", en: "Profile" },
  "profile.tab.sleeves": { ko: "슬리브", ja: "スリーブ", en: "Sleeves" },
  "profile.tab.settings": { ko: "설정", ja: "設定", en: "Settings" },
  // sleeves
  "sleeve.title": { ko: "카드 슬리브", ja: "カードスリーブ", en: "Card Sleeves" },
  "sleeve.current": { ko: "현재 슬리브", ja: "現在のスリーブ", en: "Current Sleeve" },
  "sleeve.equip": { ko: "장착", ja: "装着", en: "Equip" },
  "sleeve.equipped": { ko: "장착됨", ja: "装着中", en: "Equipped" },
  "sleeve.locked": { ko: "미보유", ja: "未所持", en: "Not owned" },
  "sleeve.getmore": { ko: "상점에서 더 보기 →", ja: "ショップで見る →", en: "Get more in the Shop →" },
  ...
  "settings.language": { ko: "언어", ja: "言語", en: "Language" },
  ...
  "shop.title": { ko: "상점", ja: "ショップ", en: "Shop" },
  "shop.sleeves": { ko: "카드 슬리브", ja: "カードスリーブ", en: "Card Sleeves" },
  "shop.desc": { ko: "카드 뒷면을 꾸며보세요. 구매한 슬리브는 프로필에서 장착할 수 있습니다.", ja: "カード裏面を彩ろう。購入したスリーブはプロフィールで装着できます。", en: "Customize your card backs. Equip purchased sleeves from your profile." },
  "shop.buy": { ko: "구매", ja: "購入", en: "Buy" },
  "shop.owned": { ko: "보유 중", ja: "所持済み", en: "Owned" },
  "shop.buy.confirm": { ko: "구매할까요?", ja: "購入しますか？", en: "Buy this?" },
  "shop.buy.ok": { ko: "구매 완료!", ja: "購入完了！", en: "Purchased!" },
  "shop.nocredit": { ko: "크레딧이 부족합니다.", ja: "クレジットが不足しています。", en: "Not enough credits." },
  "shop.credits": { ko: "보유 크레딧", ja: "所持クレジット", en: "Your credits" },
  ...
  "attack.block.guarded": { ko: "상대 필드에 몬스터가 있어 플레이어를 직접 공격할 수 없습니다 — 먼저 몬스터를 처리하세요", ja: "相手の場にモンスターがいるため、プレイヤーを直接攻撃できません — 先にモンスターを倒してください", en: "You can't attack the player while they control monsters — clear the board first" },
  // ---- controls help panel (in-game) ----
  "help.title": { ko: "조작 방법", ja: "操作方法", en: "Controls" },
  "help.open": { ko: "조작 방법", ja: "操作方法", en: "Controls" },
  "help.close": { ko: "닫기", ja: "閉じる", en: "Close" },
  "help.callout": { ko: "조작 방법은 여기서 확인하세요!", ja: "操作方法はここをみてね！", en: "Check the controls here!" },
  "help.h.cards": { ko: "카드", ja: "カード", en: "Cards" },
  "help.h.play": { ko: "플레이", ja: "プレイ", en: "Playing" },
  "help.h.attack": { ko: "공격", ja: "攻撃", en: "Attacking" },
  "help.h.market": { ko: "마켓", ja: "マーケット", en: "Market" },
  // touch
  "help.t.zoom": { ko: "카드를 탭하면 크게 볼 수 있어요.", ja: "カードをタップすると拡大表示。", en: "Tap a card to enlarge it." },
  "help.t.hand": { ko: "아래쪽 손패를 탭하면 펼쳐집니다.", ja: "下の手札をタップすると展開します。", en: "Tap your hand to expand it." },
  "help.t.play": { ko: "손패 카드를 위로 드래그하면 사용합니다. 손패로 되돌리면 취소.", ja: "手札のカードを上にドラッグで使用。手札に戻せばキャンセル。", en: "Drag a hand card upward to play it; drop it back on the hand to cancel." },
  "help.t.attack": { ko: "내 몬스터를 상대 몬스터로 드래그하면 공격, 상대 초상화로 드래그하면 직접 공격.", ja: "自分のモンスターを相手モンスターにドラッグで攻撃、相手の顔アイコンにドラッグで直接攻撃。", en: "Drag your monster onto an enemy monster to attack it, or onto the enemy portrait to attack directly." },
  "help.t.reorder": { ko: "내 몬스터를 내 필드 안에서 좌우로 끌면 순서를 바꿉니다.", ja: "自分のモンスターを自分の場の中で左右にドラッグすると並び替え。", en: "Drag a monster sideways within your own field to reorder it." },
  "help.t.market": { ko: "마켓 카드는 탭하면 확대, 더블탭하면 구매 확인이 뜨고 한 번 더 탭하면 구매합니다.", ja: "マーケットのカードはタップで拡大、ダブルタップで購入確認が出て、もう一度タップで購入します。", en: "Tap a market card to enlarge it; double-tap to arm the purchase, then tap once more to buy." },
  // desktop
  "help.d.zoom": { ko: "카드를 클릭하면 크게 볼 수 있어요 (우클릭도 동일).", ja: "カードをクリックで拡大表示（右クリックでも可）。", en: "Click a card to enlarge it (right-click works too)." },
  "help.d.play": { ko: "손패 카드를 위로 드래그하면 사용합니다. 손패로 되돌리면 취소.", ja: "手札のカードを上にドラッグで使用。手札に戻せばキャンセル。", en: "Drag a hand card upward to play it; drop it back on the hand to cancel." },
  "help.d.attack": { ko: "내 몬스터를 상대 몬스터로 드래그하면 공격, 상대 초상화로 드래그하면 직접 공격. 클릭해도 공격할 수 있어요.", ja: "自分のモンスターを相手モンスターにドラッグで攻撃、相手の顔アイコンにドラッグで直接攻撃。クリックでも攻撃できます。", en: "Drag your monster onto an enemy monster to attack it, or onto the enemy portrait for a direct attack. Clicking also works." },
  "help.d.reorder": { ko: "내 몬스터를 내 필드 안에서 좌우로 끌면 순서를 바꿉니다.", ja: "自分のモンスターを自分の場の中で左右にドラッグすると並び替え。", en: "Drag a monster sideways within your own field to reorder it." },
  "help.d.market": { ko: "마켓 카드는 클릭하면 확대, 더블클릭하면 구매 확인이 뜨고 한 번 더 클릭하면 구매합니다.", ja: "マーケットのカードはクリックで拡大、ダブルクリックで購入確認が出て、もう一度クリックで購入します。", en: "Click a market card to enlarge it; double-click to arm the purchase, then click once more to buy." },
  ...
  "card.summon": { ko: "소환", ja: "召喚", en: "Summon" },
  ...
  "market.stock": { ko: "남은 재고", ja: "残り在庫", en: "Stock left" },
  ...
  "wheel.title": { ko: "운명의 수레바퀴", ja: "運命の輪", en: "Wheel of Fate" },
  "wheel.body": { ko: "결과를 되감고 다시 굴릴까요? (매턴 1회)", ja: "結果を巻き戻して振り直しますか？(毎ターン1回)", en: "Rewind the result and reroll? (once per turn)" },
  "wheel.reroll": { ko: "다시 굴리기", ja: "振り直す", en: "Reroll" },
  "wheel.keep": { ko: "결과 유지", ja: "結果を維持", en: "Keep result" },
  "home.deck.title": { ko: "덱 편집", ja: "デッキ編集", en: "Deck Builder" },
  "home.deck.desc": { ko: "초기 덱 9장을 자유롭게 구성 (어튠 1장 고정)", ja: "初期デッキ9枚を自由に構成 (アチューン1枚固定)", en: "Build your 9-card starting deck (Attune is fixed)" },
  "deck.title": { ko: "덱 편집", ja: "デッキ編集", en: "Deck Builder" },
  "deck.note": { ko: "초기 덱은 9장 — 어튠 1장은 고정, 나머지 8장을 아래 카드들로 자유롭게 구성하세요. 각 카드는 8장씩 보유하고 있습니다. 스타팅 카드는 상점에 나오지 않습니다.", ja: "初期デッキは9枚 — アチューン1枚は固定、残り8枚を下のカードで自由に構成。各カードは8枚ずつ所持。スターティングカードはショップに出ません。", en: "Your starting deck has 9 cards — 1 Attune is fixed; pick the other 8 below. You own 8 copies of each. Starting cards never appear in the shop." },
  "deck.current": { ko: "현재 덱", ja: "現在のデッキ", en: "Current deck" },
  "deck.pool": { ko: "보유 스타팅 카드 (클릭해서 추가)", ja: "所持スターティングカード (クリックで追加)", en: "Your starting cards (click to add)" },
  "deck.fixed": { ko: "고정", ja: "固定", en: "Fixed" },
  "deck.remove": { ko: "클릭하면 덱에서 제거", ja: "クリックでデッキから外す", en: "Click to remove" },
  "deck.save": { ko: "저장", ja: "保存", en: "Save" },
  "deck.saved": { ko: "저장 완료! 다음 게임부터 적용됩니다.", ja: "保存完了！次のゲームから適用されます。", en: "Saved! Applies from your next game." },
  "deck.slot": { ko: "덱 {n}", ja: "デッキ{n}", en: "Deck {n}" },
  "deck.use": { ko: "이 덱 사용", ja: "このデッキを使う", en: "Use this deck" },
  "deck.inuse": { ko: "사용 중", ja: "使用中", en: "In use" },
  "deck.watch.title": { ko: "마켓 알림이", ja: "マーケット通知", en: "Market Watch" },
  ...
  // 대전 연출 (턴 리본 / 복귀 / 기합)
  "home.nav.guide": { ko: "가이드", ja: "遊び方", en: "Guide" },
  "home.nav.deck": { ko: "덱", ja: "デッキ", en: "Deck" },
  "home.nav.cards": { ko: "카드", ja: "カード", en: "Cards" },
  "home.nav.ranking": { ko: "랭킹", ja: "ランキング", en: "Rankings" },
  ...
  "home.title": { ko: "홈", ja: "ホーム", en: "Home" },
  "play.drop.guide": { ko: "필드로 드래그 · 손패로 되돌리면 취소", ja: "場へドラッグ・手札に戻すとキャンセル", en: "Drag onto the board · Return to hand to cancel" },
  "play.drop.release": { ko: "놓으면 플레이", ja: "離すとプレイ", en: "Release to play" },
  "play.drop.blocked": { ko: "지금 플레이할 수 없습니다", ja: "今はプレイできません", en: "Cannot play right now" },
