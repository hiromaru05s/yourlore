...
const D: Record<string, Entry> = {
  ...
  "game.mute": { ko: "음소거", ja: "ミュート", en: "Mute" },
  "play.block.mana": { ko: "마나가 부족합니다", ja: "マナが足りません", en: "Not enough mana" },
  "play.block.turn": { ko: "지금은 당신의 차례가 아닙니다", ja: "今はあなたのターンではありません", en: "It's not your turn" },
  "play.block.pending": { ko: "먼저 진행 중인 선택을 완료하세요", ja: "先に進行中の選択を完了してください", en: "Finish the current selection first" },
  "play.block.cond": { ko: "발동 조건을 충족하지 않았습니다", ja: "発動条件を満たしていません", en: "Activation condition not met" },
  "game.refresh": { ko: "갱신", ja: "更新", en: "Refresh" },
