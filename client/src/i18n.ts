...
const D: Record<string, Entry> = {
  ...
  "tut.s4.body": { ko: "손패에 <b>몬스터 카드</b>를 넣어드렸어요. 카드를 눌러 필드에 <b>소환</b>하세요. 몬스터는 <b>공격력/체력</b>을 가지고 필드에서 싸웁니다. 소환한 턴에도 바로 공격할 수 있어요!", ja: "手札に<b>モンスターカード</b>を入れました。カードを押して<b>召喚</b>しましょう。モンスターは<b>攻撃力/体力</b>を持ち場で戦います。召喚したターンにすぐ攻撃できます！", en: "A <b>monster card</b> is in your hand — tap it to <b>summon</b> it. Monsters have <b>ATK/HP</b> and fight on the field, and can attack the turn they're summoned!" },
  "tut.s5.title": { ko: "마법 시전", ja: "魔法発動", en: "Cast a Spell" },
  "tut.s5.body": { ko: "<b>마법 카드</b>를 드렸어요(파이어볼 — 상대에게 4 데미지). 마법은 <b>즉시 1회</b> 효과를 내고 묘지로 갑니다(데미지·회복·드로우·파괴 등). 카드를 눌러 <b>시전</b>하세요!", ja: "<b>魔法カード</b>を渡しました(ファイアボール — 相手に4ダメージ)。魔法は<b>即時1回</b>の効果を出し墓地へ(ダメージ・回復・ドロー・破壊など)。カードを押して<b>発動</b>！", en: "Here's a <b>spell</b> (Fireball — 4 damage). Spells are <b>one-shot</b> effects that then go to the graveyard (damage, heal, draw, destroy…). Tap it to <b>cast</b>!" },
  ...
  "tut.s7.p0": { ko: "<b>함정 카드</b>를 드렸어요. 함정은 <b>비공개로 세트</b>해두고 상대의 <b>공격·소환·마법</b>에 반응해 자동 발동합니다(발동 시 공개). 카드를 눌러 <b>세트</b>하세요.", ja: "<b>罠カード</b>を渡しました。罠は<b>非公開でセット</b>し、相手の<b>攻撃・召喚・魔法</b>に反応して自動発動します(発動時に公開)。カードを押して<b>セット</b>。", en: "Here's a <b>trap</b>. Traps are <b>set face-down</b> and fire automatically on enemy <b>attacks, summons or spells</b> (revealed when triggered). Tap it to <b>set</b> it." },
