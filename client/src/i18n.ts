...
const D: Record<string, Entry> = {
  ...
  "tut.s4.body": { ko: "손패에 <b>몬스터 카드</b>를 넣어드렸어요. 카드를 눌러 필드에 <b>소환</b>하세요. 몬스터는 <b>공격력/방어력</b>을 가지고 필드에서 싸웁니다. 소환한 턴에도 바로 공격할 수 있어요!", ja: "手札に<b>モンスターカード</b>を入れました。カードを押して<b>召喚</b>しましょう。モンスターは<b>攻撃力/防御力</b>を持ち場で戦います。召喚したターンにすぐ攻撃できます！", en: "A <b>monster card</b> is in your hand — tap it to <b>summon</b> it. Monsters have <b>ATK/DEF</b> and fight on the field, and can attack the turn they're summoned!" },
  ...
  "tut.s6.body": { ko: "필드의 <b>몬스터를 눌러</b> 공격하세요. 상대 몬스터를 칠 때 <b>내 공격력 &gt; 상대 방어력</b>이면 파괴하고 초과분이 <b>관통</b> 데미지로 들어가요. 상대 필드가 비면 <b>체력을 직접</b> 때립니다!", ja: "場の<b>モンスターを押して</b>攻撃。相手モンスターを攻撃する時<b>自分の攻撃力 &gt; 相手の防御力</b>なら破壊し、超過分が<b>貫通</b>ダメージに。相手の場が空なら<b>体力を直接</b>攻撃！", en: "Tap your <b>field monster</b> to attack. Vs a monster: if <b>your ATK &gt; its DEF</b> it dies and the excess hits as <b>penetration</b>. With no enemy monsters, you hit <b>HP directly</b>!" },
