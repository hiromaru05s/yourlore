...
const D: Record<string, Entry> = {
  ...
  "tut.s6.body": { ko: "필드의 <b>몬스터를 눌러</b> 공격하세요. 상대 몬스터를 치면 <b>데미지가 체력에 누적</b>돼요. 체력 0이면 파괴, 막타 초과분은 <b>관통</b> 데미지! 상대 필드가 비면 <b>체력을 직접</b> 때립니다!", ja: "場の<b>モンスターを押して</b>攻撃。相手モンスターを攻撃すると<b>ダメージが体力に蓄積</b>。体力0で破壊、とどめの超過分は<b>貫通</b>ダメージ！相手の場が空なら<b>体力を直接</b>攻撃！", en: "Tap your <b>field monster</b> to attack. Attacks <b>accumulate damage on a monster's HP</b>; at 0 it dies and the killing blow's excess <b>pierces</b>. With no enemy monsters, you hit <b>HP directly</b>!" },
