...
const D: Record<string, Entry> = {
  ...
  "tutorial.inter.desc": { ko: "실제 게임 화면에서 9단계로 배워요. 단계마다 크레딧을 드리고, <b>전부 수료하면 총 890💎</b>!", ja: "実際のゲーム画面で9ステップで学べます。ステップごとにクレジット、<b>全部クリアで合計890💎</b>！", en: "Learn in 9 hands-on steps on the real board. Earn credits each step — <b>890💎 total</b> for finishing!" },
  ...
  "tut.s5.body": { ko: "<b>마법 카드</b>를 드렸어요(별무덤 낙하 — 상대에게 11 데미지). 마법은 <b>즉시 1회</b> 효과를 내고 묘지로 갑니다(데미지·회복·드로우·파괴 등). 카드를 <b>위로 드래그해 시전</b>하세요!", ja: "<b>魔法カード</b>を渡しました(星墓の落下 — 相手に11ダメージ)。魔法は<b>即時1回</b>の効果を出し墓地へ(ダメージ・回復・ドロー・破壊など)。カードを<b>上へドラッグして発動</b>！", en: "Here's a <b>spell</b> (Fall of the Star-Tomb — 11 damage). Spells are <b>one-shot</b> effects that then go to the graveyard (damage, heal, draw, destroy…). <b>Drag it up to cast</b>!" },
  ...
  "tut.s10.body": { ko: "훌륭해요! 상대 체력이 <b>거의 없습니다</b>. 필드의 몬스터로 <b>직접 공격</b>해 마무리하고 튜토리얼을 <b>완주</b>하세요! (총 <b>890💎</b> 획득)", ja: "お見事！相手の体力は<b>ほぼ残っていません</b>。場のモンスターで<b>直接攻撃</b>してとどめを刺し、チュートリアルを<b>完走</b>しましょう！(合計<b>890💎</b>獲得)", en: "Great work! The opponent is <b>nearly finished</b>. <b>Attack directly</b> with your monster to end it and <b>complete</b> the tutorial! (Total <b>890💎</b>)" },
  ...
  "help.t.market": { ko: "구매 가능한 마켓 카드를 탭해 선택하고, 다시 탭하거나 구매 버튼을 누르세요. 길게 누르면 확대합니다.", ja: "購入できるマーケットのカードをタップで選択。もう一度タップ、または購入ボタンで購入します。長押しで拡大。", en: "Tap an available market card to select it, then tap again or use the purchase button to buy. Hold to inspect." },
  // desktop
  ...
  "help.d.market": { ko: "구매 가능한 마켓 카드를 클릭해 선택하고, 다시 클릭하거나 구매 버튼을 누르세요. 우클릭하면 확대합니다.", ja: "購入できるマーケットのカードをクリックで選択。再クリック、または購入ボタンで購入します。右クリックで拡大。", en: "Click an available market card to select it, then click again or use the purchase button to buy. Right-click to inspect." },
