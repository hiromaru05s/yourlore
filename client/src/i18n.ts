...
const D: Record<string, Entry> = {
  ...
  "tut.s2.body": { ko: "가운데 <b>마켓</b>에서 마나로 카드를 삽니다. <b>고정 마켓</b>은 매판 같은 10장, <b>제시 마켓</b>은 매 턴 바뀌는 3장이에요. 산 카드는 <b>묘지</b>로 갔다가 덱이 떨어지면 섞여 들어옵니다. 아무 카드나 <b>1장 구매</b>해보세요!", ja: "中央の<b>マーケット</b>でマナを使いカードを買います。<b>固定マーケット</b>は毎ゲーム同じ10枚、<b>提示マーケット</b>は毎ターン変わる3枚です。買ったカードは<b>墓地</b>へ行き、デッキが尽きると混ざって戻ります。どれでも<b>1枚購入</b>！", en: "Buy cards with mana in the central <b>market</b>. The <b>fixed market</b> is the same 10 all game; the <b>offer</b> refreshes each turn. Purchases go to your <b>graveyard</b> and shuffle back in. <b>Buy any one card</b>!" },
  "tut.s3.title": { ko: "제시 리롤", ja: "提示リロール", en: "Reroll the Offer" },
  "tut.s3.body": { ko: "<b>제시 마켓</b>이 마음에 안 들면 <b>갱신(리롤)</b> 버튼으로 <b>1마나</b>를 내고 3장을 새로 뽑을 수 있어요. 원하는 카드가 없을 때 유용합니다. <b>갱신</b> 버튼을 눌러보세요!", ja: "<b>提示マーケット</b>が気に入らなければ<b>更新(リロール)</b>ボタンで<b>1マナ</b>を払い3枚を引き直せます。欲しいカードが無い時に便利。<b>更新</b>ボタンを押してみましょう！", en: "Don't like the <b>offer</b>? The <b>reroll</b> button spends <b>1 mana</b> to draw 3 fresh cards — great when nothing fits. Tap the <b>reroll</b> button!" },
