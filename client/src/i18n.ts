...
const D: Record<string, Entry> = {
  ...
  "tut.s8.body": { ko: "<b>같은 종족</b>(고독)의 서로 <b>다른</b> 몬스터 2장을 드렸어요. 둘 다 <b>소환</b>하면 <b>동족 2종 시너지</b>가 터집니다! 종족은 고독·고귀·포식·귀족·시초 5종이 있어요. 두 마리를 <b>모두 소환</b>하세요!", ja: "<b>同じ種族</b>(孤独)の<b>異なる</b>モンスター2枚を渡しました。両方<b>召喚</b>すると<b>同族2種シナジー</b>が発動！種族は孤独・高貴・捕食・貴族・始原の5種。2体とも<b>召喚</b>しましょう！", en: "You have two <b>different</b> monsters of the <b>same tribe</b> (Solitary). <b>Summon both</b> to trigger a <b>2-of-a-tribe synergy</b>! There are 5 tribes. <b>Summon both</b> monsters!" },
