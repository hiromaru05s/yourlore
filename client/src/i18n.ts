...
const D: Record<string, Entry> = {
  ...
  "home.tutorial.title": { ko: "튜토리얼", ja: "チュートリアル" },
  "home.tutorial.desc": { ko: "게임 방법을 한눈에 알아보세요.", ja: "ゲームの遊び方をひと目で。" },
  "home.cards.title": { ko: "카드 리스트", ja: "カードリスト" },
  "home.cards.desc": { ko: "모든 카드를 한눈에 둘러보세요.", ja: "すべてのカードを一覧で。" },
  // card list / gallery
  "cards.title": { ko: "카드 리스트", ja: "カードリスト" },
  "cards.back": { ko: "뒤로", ja: "戻る" },
  "cards.search": { ko: "이름 검색…", ja: "名前で検索…" },
  "cards.count": { ko: "장", ja: "枚" },
  "cards.empty": { ko: "조건에 맞는 카드가 없습니다.", ja: "条件に合うカードがありません。" },
  "cards.hint": { ko: "카드를 누르면 크게 볼 수 있어요.", ja: "カードをタップで拡大できます。" },
  "cards.f.all": { ko: "전체", ja: "すべて" },
  "cards.f.mon": { ko: "몬스터", ja: "モンスター" },
  "cards.f.spell": { ko: "마법", ja: "魔法" },
  "cards.f.trap": { ko: "함정", ja: "罠" },
  "cards.f.starter": { ko: "스타터", ja: "スターター" },
  "cards.cost.all": { ko: "코스트 전체", ja: "コスト全部" },
  "tutorial.title": { ko: "게임 방법", ja: "ゲームの遊び方" },
  "tutorial.back": { ko: "뒤로", ja: "戻る" },
  "tutorial.start": { ko: "BOT으로 바로 해보기", ja: "BOTで早速プレイ" },
