...
- 罠カード全32種類を削除し、指定の関連カード7枚を削除・10枚をリワーク、トラップマスターを廃止しました（v44）。削除一覧・影響カード・並行デザイン作業とのマージ手順は [罠廃止の作業記録](docs/card-rework/2026-09-09-trap-removal/README.md) を参照してください。
