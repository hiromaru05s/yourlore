...
const TEXTS = {
    ...
    VAMP4: "When you cast a 'Blood Magic': summon a Supreme Vampire (once) · Gains max HP equal to 50% of the damage it deals to the opponent · Void",
    VAMP5: "On summon: deal 15 damage to the opponent and gain +30 max HP · Gains max HP equal to the damage it deals to the opponent · Trap Master · Void",
    FLAME: "Deal 2 damage to the opponent, take 1 damage",
    GHOST: "Infiltrate · Whenever the opponent raises their max mana/max HP, you take 3 damage",
    ...
    FATE_WHEEL: "Permanent: on cast, your max mana -1 and take 8 damage · After seeing a dice/chance card's result, you may reroll it (once per turn) · Void",
    ...
    FORESIGHT: "Permanent: when your max mana reaches 9+, gain +2 max mana and destroy this card · Castable only while you have no 'Foresight' on your field · Void",
    ...
    CHOSEN_KNIGHT: "Passive: +1/+1 per 'Cull' of yours exiled from the game · Whenever it damages the opponent, add a Cull to your graveyard",
    CHOSEN_MAGE: "Passive: +1/+1 per 'Cull' of yours exiled from the game · (Optional) At turn start: return 1 exiled 'Cull' to your graveyard and deal 6 damage",
    CHOSEN_ARCHER: "Passive: +2 ATK per 'Cull' of yours exiled from the game · Infiltrate · Evade",
    CHOSEN_ROGUE: "Passive: +1 ATK per 'Cull' of yours exiled from the game · Infiltrate · Evade",
    CHOSEN_AREA: "Castable only while 20+ of your 'Culls' are exiled from the game · Win the game immediately",
    ...
    D_BLACK: "On summon: choose up to 8 of the opponent's exiled cards and send them to their graveyard · All enemy monsters -3 DEF (lasting) · Aura · Void",
    D_RED: "On summon: deal 15 damage to the opponent · Your spells deal +3 extra damage to the opponent · Aura · Void",
    D_BLUE: "On summon: your max HP +20 · At the start of your turn: max HP + the number of enemy monsters · Aura · Void",
...
const RULES = [
    ...
    [/^부패$/, "Decay"],
    [/^암습$/, "Infiltrate"],
    [/^매 턴 시작 시 체력 \+(\d+) 회복 · 도발$/, "At the start of each turn: restore $1 HP · Taunt"],
