const NAMES = {
    ...
    INQUISITION: "Inquisition", MIMIC_LORD: "Mimic Lord", VITAL2: "Vitality Devotee", VITAL3: "Vitality Priest", VITAL4: "Full-Blooded Warrior",
    CULL_FLOOD: "Baptism of Culls", PAIN_HARVEST: "Pain Harvest", CULL_FARM: "Cull Farm", PURGE_ALL: "The Great Purge",
    EXILE_NUKE1: "Void Barrage", EXILE_NUKE2: "Void Cataclysm", CULL_TITAN: "Avatar of Culls", TOKEN00: "Scarecrow", SOLDIER2: "Soldier",
...
const TEXTS = {
    ...
    MIMIC_LORD: "On summon: +3/+3 per 'Mimic' on either field",
