...
Object.assign(TEXTS, {
    ...
    PURGE_TOUCH: "Exile 1 card from your graveyard + draw 1 card · Remove all your counters (Cast 1)",
    ...
    MEDITATE: "Only while your max mana is 11 or less · Fully heal; gain 1 counter",
    MASSACRE: "Your max mana -1 · Destroy all enemy monsters",
    S12: "Roll a die: on 5+, put 1 counter on the opponent",
    ...
    GS6_4: "If the opponent is Branded, put 3 more counters on them (Cast 3)",
...
Object.assign(TEXTS, {
    ...
    GUILD_HQ: "【Passive】When an Assassin hits the opponent: 1 counter · 【Each Turn】A night market sells any Assassin card",
...
Object.assign(TEXTS, {
    ...
    T4: "【When Attacked】Negate the attack · Brand the opponent 1 counter",
    T6: "【When Attacked】Negate · Each side predicts a face, roll 1 die · Their hit: 1 Brand on you; yours: 3 on them",
    ...
    GT5_1: "【When Attacked】Negate + destroy the attacker · If its ATK is 4+, brand the opponent 1 counter",
    ...
    ACID_RAIN: "Permanent: whenever an enemy monster dies to Decay, brand the opponent 1 counter",
    ...
    TREASON: "Only if the enemy has a Castle · Destroy all cards on the enemy field, brand them 3 counters",
    STRONG_ACID: "Permanent: on cast, 2 Decay on every enemy monster · Enemy dies to Decay: 7 damage + 1 Brand",
    ROTTEN_GROUND: "Permanent: every monster summoned gets 2 counters",
    UNBRAND: "Remove all counters from both players",
...
Object.assign(TEXTS, {
    WASH_DEVICE: "Destroy every enemy monster with Decay · The enemy gains that many counters",
    ...
    UNBRANDER: "On summon: if you have a counter, remove 1 of your counters",
...
Object.assign(TEXTS, {
    ...
    PENANCE: "Per counter you have: max mana +2, max HP +10",
