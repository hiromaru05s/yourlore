...
const TEXTS = {
    ...
    GHOST: "Can only attack the opponent directly (never monsters) · Whenever the opponent raises their max mana/max HP, you take 3 damage",
    NEGOTIATE: "Opponent's max mana +1 · The opponent cannot set traps next turn",
    BLOOD_RITE: "Permanent: both players take no spell damage and heal that amount instead · Exiled from the game when destroyed",
    WEAKEN_ALL: "Permanent: all monsters on both fields have -2 ATK · Exiled from the game when destroyed",
    GUILD_HALL: "Aura: gain a count whenever your 'Assassin' monsters damage the opponent · At 3 counts: deal 14 damage (count resets) · The count is lost if this card is destroyed",
    MIMIC_PARTY: "Trap: when the opponent uses a Treasure Chest — summon 1 Mimic to their field and 2 Mimics to yours",
    FATE_WHEEL: "Permanent: on cast, your max mana -1 and take 8 damage · After seeing a dice/chance card's result, you may reroll it (once per turn) · Exiled from the game when destroyed",
    ...
    TRUMPET: "2 of your monsters gain +1 ATK (this turn)",
    FORESIGHT: "Permanent: when your max mana reaches 9+, gain +2 max mana and destroy this card · Exiled from the game when it leaves the field",
